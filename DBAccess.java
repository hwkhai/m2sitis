...
while (true){
        try
        {
            ...
            //PREMIERE BIS REQUETE : Créer un patient
                        else {
             ...
             //DEUXIEME REQUETE : Informations d'hospitalisation
                        		...
                        		if (tmp.equals("1")) {
                                    ...
                                    while (hosp.next()){
                                		...
                                		System.out.println("Fin des informations");
